module clm_varctl
  ...
  character(len=fname_len), public :: clay_frc   = ' '        ! alternative clay fraction, dmleung, 2 Mar 2021, re-added 14 Dec 2021
  character(len=fname_len), public :: rough_fct   = ' '       ! roughness factor, dmleung, 16 Jul 2020, re-added 17 Dec 2021
  character(len=fname_len), public :: lulc_frc   = ' '        ! LULC area fraction, dmleung, 7 Jul 2021, re-added 17 Dec 2021
